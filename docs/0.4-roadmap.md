...
| 順 | 版 | 内容 |
|----|-----|------|
| 1 | **0.3.1** | ルビ（Structure 優先 → geometry、`--ruby`、青空記法） |
| 2 | **0.4.0** | E0 公開 API + exposed-modules 整理 |
| 3 | **0.4.0/1** | D2 CI（並行可） |
| 4 | **0.4.1** | D7 CLI サブコマンド |
| 5 | **0.4.2** | D5（DCTDecode）+ E2 段落 diff |
| 6 | **0.4.3** | E3 `extract images` |
